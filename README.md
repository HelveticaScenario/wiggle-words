#wiggle words
> An experiment to create a flexible text layout engine in famo.us.

[![Build Status](https://travis-ci.org/thecontrarian/wiggle-words.svg?branch=master)](https://travis-ci.org/thecontrarian/wiggle-words) [![Dependency Status](https://david-dm.org/thecontrarian/wiggle-words.svg)](https://david-dm.org/thecontrarian/wiggle-words) [![devDependency Status](https://david-dm.org/thecontrarian/wiggle-words.svg)](https://david-dm.org/thecontrarian/wiggle-words#info=devDependencies)
...
## Release History
 * 2014-05-06   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)